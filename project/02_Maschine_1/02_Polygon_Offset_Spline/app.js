(function()
{
    ...
    function App(element)
    {
        ...
        while(++i < charsDataOffset.length)
        {
            ...
            temp0 = PRPolygonUtil.makeInset(temp3.slice(),10);
            ...
            j = -1;
            temp0 = PRPolygonUtil.makeOptHeading(temp3.slice());
            temp1 = charsDataOffsetClean[i] = new Float32Array(temp0.length * 0.5 * 3);
            while(++j < temp0.length * 0.5)
            {
                temp1[j * 3    ] = temp0[j * 2] * n;
                temp1[j * 3 + 1] = 0.0;
    ...
    App.prototype.update = function()
    {
        ...
        var temp;
        var x, y, z, t, d;
        var numObjs = charsDataOffset.length;
        ...
        while(++i < numObjs)
        {
            ...
            gl.linev(charsDataOffsetClean[i]);
