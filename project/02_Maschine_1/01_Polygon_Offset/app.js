(function()
{
    ...
    function App(element)
    {
        ...
        var vectorData2d     = PRLogoVectorData.Mx1,
            vectorDataOffset = 2,
            charsDataOffset  = this._charsDataOffset = new Array(vectorData2d.length - vectorDataOffset),
            charsData        = this._charsData       = new Array(vectorData2d.length - vectorDataOffset);
        ...
        {
            temp3 = PRPolygonUtil.makeOptEdgeLength(vectorData2d[++k],4);
            temp0 = PRPolygonUtil.makeInset(temp3.slice(),5);
            temp1 = charsDataOffset[i] = new Float32Array(temp3.length * 0.5 * 3);
            ...
            j = -1;
            temp1 = charsData[i] = new Float32Array(temp3.length * 0.5 * 3);
        ...
        var charTangents = this._charsTangents = new Array(charsDataOffset.length);

        i = -1;

        while(++i < charsDataOffset.length)
        {
            temp1 = charsDataOffset[i];
