(function()
{
    ...
    function App(element)
    {
        ...
        while(++i < charsDataOffset.length)
        {
            ...
            temp2 = PRPolygonUtil.makeOptHeading(temp3);
            temp0 = PRPolygonUtil.makeInset(temp2.slice(),10);
            ...
            j = -1;
            temp5 = charsDataOffsetInsideRemoved = this._charsDataOffsetInsideRem[i] = new Float32Array(temp4.length * 0.5 * 3);
    ...
    App.prototype.update = function()
    {
        ...
        while(++i < numObjs)
        {
            ...
            gl.color1f(1);
            gl.linev(charsDataOffsetInsideRem[i]);
            gl.color1f(0.45);
