    ...
    App.prototype.update = function()
    {
        ...
        while(++i < sizeZ0)
        {
            ...
            while(++j < sizeX0)
            {
                ...
                //console.log(index);
                verts0[index+1] = Math.cos((-0.5+i/sizeZ0)*(-0.5+j/sizeX0)*Math.PI*20  + time*2)*0.025*verts0[index+3];
                verts1[index+1] = Math.sin((-0.5+i/sizeZ0)*(-0.5+j/sizeX0)*Math.PI*20  + time*2)*0.025*verts1[index+3];

                colors1[index ] = verts1[index+1]*2;
        ...
        gl.drawElements(edges1,null,colors1,null,indices1,gl.getDrawMode());
