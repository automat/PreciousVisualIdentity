(function()
{
    ...
    function App(element)
    {
        ...
        var logoData = PRLogoVectorData.MHx1,
            dataNorm = 1.0 / 500.0;

        var logoDataOffset = 1;
        ...
        while(++i < logoData.length)
        {
            ...
            buffer = new GLKit.LineBuffer3d(len,4,0.01);
            buffer.setPoints(data);
            buffer.update();
            buffer.updateVertexNormals();

            buffers0.push(buffer);

            buffer = new GLKit.LineBuffer3d(len,2,0.01);
            buffer.setPoints(data);
            buffer.update();
            buffer.updateVertexNormals();
    ...
    App.prototype.update = function()
    {
        ...
        gl.clear3f(7/255,10/255,13/255);
        gl.loadIdentity();
