(function()
{
    ...
    function App(element)
    {
        ...
        while(++i < logoData.length)
        {
            ...
            buffer = new GLKit.LineBuffer3d(data.length / 3,2,0.005);
    ...
    App.prototype.update = function()
    {
        ...
        */
        ...
        while(++i < bn)
        {
            ...
            while(++j < pn)
            {
                buffer.setDiameter(j,GLKit.Math.rect(Math.sin(j/pn*Math.PI+ time * 2))*(0.125 + Math.abs(Math.sin(i/bn*Math.PI*4+time)*0.055)));
            }
